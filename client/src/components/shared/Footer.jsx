  ...
  return (
    <footer className="border-t border-border bg-card/50 backdrop-blur-sm mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        {/* Bottom bar */}
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-semibold text-muted-foreground">
          <p>© {new Date().getFullYear()} BidVault Luxury Auctions. All rights reserved.</p>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/25 text-foreground shadow-sm transition-all hover:border-primary/50 hover:shadow-glow">
            <span>Designed & Engineered with</span>
            <Heart className="w-3.5 h-3.5 text-rose-500 fill-rose-500 animate-pulse" />
            <span>by</span>
            <span className="font-extrabold text-primary tracking-wide text-sm">Devansh & Team</span>
          </div>
        </div>
      </div>
    </footer>
